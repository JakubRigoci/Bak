                ...
                <v-card elevation="4" light>
                    ...
                    <v-card-text>
                        <v-form ref="form" v-model="valid">
                            ...
                            <v-text-field color="secondary" :rules="[(this.user.password === this.passwordMatch) || 'Hesla se musí zhodovat']" outline label="Zopakovat heslo*" type="password" v-model="passwordMatch"></v-text-field>
