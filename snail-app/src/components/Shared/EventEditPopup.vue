            ...
            <v-card-text>
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12">
                            <v-select color="info" item-color="info" v-model="event.udalostTypId" :rules="selectRules" :items="eventTypes" item-text="popis" item-value="udalostTypId" label="Typ události*" required></v-select>
                        </v-col>
                    </v-row>
                </v-container>
                <small>*Povinní</small>
